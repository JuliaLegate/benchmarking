...
if use_fused == true
    println("[cuNumeric] Fused kernel benchmark on $(N) elements for $(n_samples) iterations")
    ...
    println("[cuNumeric] Unfused kernel benchmark on $(N) elements for $(n_samples) iterations")
